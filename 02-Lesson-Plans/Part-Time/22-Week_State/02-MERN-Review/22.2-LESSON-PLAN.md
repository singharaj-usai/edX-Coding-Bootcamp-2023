# 22.2 Weekday Lesson Plan:  MERN Review
...
| 0:10   | 2   | Instructor Demo: React Hooks        | 0:05     |
| 0:15   | 3   | Student Do: React Hooks             | 0:15     |
| 0:30   | 4   | Instructor Review: React Hooks      | 0:10     |
| 0:40   | 5   | Instructor Demo: React Router       | 0:05     |
| 0:45   | 6   | Student Do: React Router            | 0:15     |
| 1:00   | 7   | Instructor Review: React Router     | 0:10     |
| 1:10   | 8   | Instructor Demo: Apollo Client      | 0:05     |
| 1:15   | 9   | Student Do: Apollo Client           | 0:15     |
| 1:30   | 10  | BREAK                               | 0:15     |
| 1:45   | 11  | Instructor Review: Apollo Client    | 0:10     |
| 1:55   | 12  | Instructor Demo: JWT                | 0:05     |
| 2:00   | 13  | Student Do: JWT                     | 0:15     |
| 2:15   | 14  | Instructor Review: JWT              | 0:10     |
| 2:25   | 15  | Instructor Demo: useReducer Hook    | 0:05     |
| 2:30   | 16  | Student Do: useReducer Hook         | 0:15     |
| 2:45   | 17  | Instructor Review: useReducer Hook  | 0:15     |
| 3:00   | 18  | END                                 | 0:00     |
...
* Ask the class the following questions (☝️) and call on students for the answers (🙋):
  ...
  * 🙋 We can refer to supplemental material, read the [React Router documentation](https://reactrouter.com/docs/en/v6/getting-started/overview#overview), and stay for office hours to ask for help.
